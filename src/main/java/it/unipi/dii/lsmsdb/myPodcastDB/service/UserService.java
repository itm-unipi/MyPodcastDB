...
public class UserService {
    ...
    public boolean loadFollowedAuthorsRegistered(Author author, List<Pair<Author, Boolean>> followed, int limit, int skip) {
    ...
    public boolean loadFollowedAuthorsUnregistered(Author author, List<Pair<Author, Boolean>> followed, int limit, int skip) {
        Logger.info("Retrieving followed authors");
        Neo4jManager.getInstance().openConnection();
    ...
    public boolean loadMoreAuthorsRegistered(String searchText, List<Pair<Author, Boolean>> authorsMatch, int limit, int skip) {
        MongoManager.getInstance().openConnection();
        Neo4jManager.getInstance().openConnection();
    ...
    public boolean loadMoreAuthorsUnregistered(String searchText, List<Pair<Author, Boolean>> authorsMatch, int limit, int skip) {
        MongoManager.getInstance().openConnection();
        boolean noMoreAuthors = false;
